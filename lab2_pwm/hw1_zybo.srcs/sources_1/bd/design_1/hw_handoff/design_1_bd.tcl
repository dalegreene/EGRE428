...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set speed_out [ create_bd_port -dir O speed_out ]
...
CONFIG.PCW_IMPORT_BOARD_PRESET {Z:/HanBeul/Documents/VCU/EGRE428 - Intro to Integrated System Design/hw0_zybo/ZYBO_zynq_def.xml} \
...
CONFIG.NUM_MI {1} \
  ...
  # Create instance: test_core_0, and set properties
  set test_core_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:test_core:1.0 test_core_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins processing_system7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins test_core_0/S00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins test_core_0/s00_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins test_core_0/s00_axi_aresetn]
  connect_bd_net -net test_core_0_speed_out [get_bd_ports speed_out] [get_bd_pins test_core_0/speed_out]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs test_core_0/S00_AXI/S00_AXI_reg] SEG_test_core_0_S00_AXI_reg
...
preplace port speed_out -pg 1 -y 130 -defaultsOSRD
preplace inst test_core_0 -pg 1 -lvl 3 -y 130 -defaultsOSRD
...
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 270
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 -120 40 240
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 2 280 230 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 270 NJ 270 NJ
preplace netloc test_core_0_speed_out 1 3 1 N
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 1 250
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 -130 30 260 240 NJ
levelinfo -pg 1 -150 60 550 827 960 -top 0 -bot 440
",
}
